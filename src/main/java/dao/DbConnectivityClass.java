...
public class DbConnectivityClass {
    ...
    final static String SQL_SERVER_URL = "jdbc:mysql://csc311.mysql.database.azure.com/";//update this server name
    public final static String DB_URL = SQL_SERVER_URL+DB_NAME;//update this database name
    public final static String USERNAME = "super_admin";// update this username
    public final static String PASSWORD = "ThisIsAPassword1";// update this password
    ...
    public boolean connectToDatabase() {
        ...
        try {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS users ("
                    ...
                    + "password VARCHAR(200) NOT NULL," // Added password field
